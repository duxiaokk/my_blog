...
Revision ID: 32c1f746183e
Revises: 0001_initial
Create Date: 2026-04-27 14:25:49.252886
...
def downgrade() -> None:
    ...
    op.drop_index("ix_agent_tasks_target_id", table_name="agent_tasks")
    op.drop_index("ix_agent_tasks_target_type", table_name="agent_tasks")
